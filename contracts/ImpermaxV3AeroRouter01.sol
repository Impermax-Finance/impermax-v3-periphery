...
contract ImpermaxV3AeroRouter01 is ImpermaxV3BaseRouter01, INftlpCallee {
	...
	constructor(address _factory, address _tokenizedAeroCLFactory, address _WETH, address _nextAeroIdGetter) public ImpermaxV3BaseRouter01(_factory, _WETH) {
	...
	function _reset() internal {
		_withdrawToken(rewardsToken, msg.sender);
		storedTickSpacing = 0;
		storedTickLower = 0;
		storedTickUpper = 0;
	}
